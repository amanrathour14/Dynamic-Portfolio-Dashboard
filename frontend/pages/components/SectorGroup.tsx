  ...
  return (
    <React.Fragment>
      <tr className="bg-gray-100/80 cursor-pointer hover:bg-gray-200 transition-colors" onClick={() => onToggleExpand(sector)}>
        <td colSpan={9} className="px-6 py-3 whitespace-nowrap text-sm font-semibold text-gray-800 force-black">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="force-black">{sector}</span>
            </div>
            <span className="text-xs text-gray-500 force-black">{isExpanded ? 'Click to collapse' : 'Click to expand'}</span>
          </div>
        </td>
      </tr>
      ...
      <tr className="bg-gray-100">
        <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-800 force-black">Total for {sector}</td>
        <td colSpan={2} className="px-6 py-4 text-right whitespace-nowrap text-sm font-semibold text-gray-800 force-black">{formatCurrency(summary.investment)}</td>
        <td colSpan={2} className="px-6 py-4 text-right whitespace-nowrap text-sm font-semibold text-gray-800 force-black">{formatCurrency(summary.presentValue)}</td>
